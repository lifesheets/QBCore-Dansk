...
var guildId = "911697271144464476"; // Guild ID for a Discord Server, see https://faxes.zone/i/zjKnd.png
var botToken = "NzYxMjY3ODYxMjEyODg5MDk4.X3YH8Q.br3U4Falx5tvt48e-blJCePOiCk"; // This must be a Discord bot token, create a bot @ https://discord.com/developers/applications
...
on('playerConnecting', async (name, setKickReason, deferrals) => {
    ...
    deferrals.defer();
    setTimeout(() => {
        deferrals.update(`Hej ${name}. Dit Discord ID bliver tjekket med vores Whitelist.`)
        setTimeout(async function() {
            getUserDiscord(src, async function(userId) {
                if(userId) {
                    ...
                    return deferrals.done(`Du skal forbinde Discord med FiveM. Hvis du har brug for hjælp så lav en ticket på vores Discord.`);
                }
            });
        }, 0)
    }, 0)
