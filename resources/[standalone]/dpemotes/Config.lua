...
-- You can disable the (F3) menu here / change the keybind.
	...
	MenuKeybind = 289, -- Standard er 170 som er f3 og 289 = f2  -- Get the button number here https://docs.fivem.net/game-references/controls/
...
-- NOte this might cause an issue of the image getting stuck on peoples screens
	...
	MenuImage = "https://i.imgur.com/WBLJpgS.png",
...
Config.Languages = {
  ...
  ['da'] = {
    ...
    ['favoriteinfo'] = "Vælg en emote her for at sætte det som din favorit.",
