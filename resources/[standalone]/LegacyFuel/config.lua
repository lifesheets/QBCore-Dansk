...
Config.Strings = {
	...
	EToRefuel = "Tryk ~g~E ~w~for at optanke køretøjet",
	JerryCanEmpty = "Benzindunken er tom",
	FullTank = "Tanken er fuld",
	PurchaseJerryCan = "Tryk ~g~E ~w~for at købe en benzindunk for ~g~" .. Config.JerryCanCost .. " DKK",
	CancelFuelingPump = "Tryk ~g~E ~w~for at annullere optankning",
	CancelFuelingJerryCan = "Tryk ~g~E ~w~for at annullere optankning",
	NotEnoughCash = "Ikke nok penge",
	RefillJerryCan = "Tryk ~g~E ~w~ for at genoptanke benzindunken for ",
	NotEnoughCashJerryCan = "Ikke nok penge til at genoptanke benzindunken",
	JerryCanFull = "Benzindunken er fuld",
	TotalCost = "Kost",
}
