    ...
    if source and source ~= '' then
        if citizenid then
            ...
            if PlayerData and license == PlayerData.license then
                ...
                DropPlayer(source, 'Du Er Blevet Kicket For: exploiting')
...
function QBCore.Player.CheckPlayerData(source, PlayerData)
    ...
    PlayerData.charinfo.firstname = PlayerData.charinfo.firstname or 'Navn'
    PlayerData.charinfo.lastname = PlayerData.charinfo.lastname or 'Efternavn'
    PlayerData.charinfo.birthdate = PlayerData.charinfo.birthdate or '00-00-0000'
    PlayerData.charinfo.gender = PlayerData.charinfo.gender or 0
    PlayerData.charinfo.backstory = PlayerData.charinfo.backstory or 'Karakter Baggrund'
    ...
    PlayerData.metadata['callsign'] = PlayerData.metadata['callsign'] or 'INTET KALDESIGNAL'
    ...
    PlayerData.gang.label = PlayerData.gang.label or 'Ingen Bande'
...
function QBCore.Player.CreatePlayer(PlayerData)
    ...
    function self.Functions.SetJob(job, grade)
        ...
        if QBCore.Shared.Jobs[job].grades[grade] then
            ...
            self.PlayerData.job.grade = {}
            self.PlayerData.job.grade.name = 'Ingen Grader'
    ...
    function self.Functions.SetGang(gang, grade)
        ...
        if QBCore.Shared.Gangs[gang].grades[grade] then
            ...
            self.PlayerData.gang.grade = {}
            self.PlayerData.gang.grade.name = 'Ingen Grader'
...
function QBCore.Player.CreateWalletId()
    ...
    local WalletId = nil
    while not UniqueFound do
        WalletId = 'DRP-' .. math.random(111111, 999999)
