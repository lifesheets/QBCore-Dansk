	...
	if Employee then
		if target ~= Player.PlayerData.citizenid then
			if Employee.Functions.SetGang("none", '0') then
				...
				TriggerClientEvent('QBCore:Notify', src, "Bandemedlem fyret!", "success")
				TriggerClientEvent('QBCore:Notify', Employee.PlayerData.source , "Du er blevet smidt ud af banden!", "error")
			else
				TriggerClientEvent('QBCore:Notify', src, "Fejl.", "error")
			end
		else
			TriggerClientEvent('QBCore:Notify', src, "Du kan ikke smide dig selv ud af banden!", "error")
		end
	else
...
RegisterNetEvent('qb-gangmenu:server:HireMember', function(recruit)
	...
	if Target and Target.Functions.SetGang(Player.PlayerData.gang.name, 0) then
		TriggerClientEvent('QBCore:Notify', src, "Du hyrede " .. (Target.PlayerData.charinfo.firstname .. ' ' .. Target.PlayerData.charinfo.lastname) .. " come " .. Player.PlayerData.gang.label .. "", "success")
		TriggerClientEvent('QBCore:Notify', Target.PlayerData.source , "Du er blevet hyret som " .. Player.PlayerData.gang.label .. "", "success")
