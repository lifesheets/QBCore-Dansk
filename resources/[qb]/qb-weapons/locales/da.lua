local Translations = {
    error = {
        ...
        weapon_broken = 'Dette våben er gået i stykker og kan ikke bruges.',
        no_damage_on_weapon = 'Dette våben er ikke skadet..',
        weapon_broken_need_repair = 'Dit våben er gået i stykker, du skal reparere det før du kan bruge det.',
    ...
    mail = {
        sender = 'Tyrone',
        subject = 'Reparer',
        message = 'Din %{value} er repareret, du kan hente det på følgende lokation.'
    },
}
