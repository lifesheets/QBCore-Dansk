    ...
    if cards and cards[1] then
        ...
        for _, v in pairs(Config.ATMModels) do
            ...
            if atm then
                ...
                QBCore.Functions.Progressbar("accessing_atm", "Tilgår Hæveautomat", 1500, false, true, {
        ...
        QBCore.Functions.Notify("Besøg venligst en bank for at bestille et kort", "error")
    end
end)
