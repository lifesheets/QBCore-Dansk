...
function openLocker(bankId, lockerId) -- Globally Used
    ...
    if bankId == "paleto" then
        QBCore.Functions.TriggerCallback('QBCore:HasItem', function(hasItem)
            if hasItem then
                ...
                IsDrilling = true
                QBCore.Functions.Progressbar("open_locker_drill", "Bryder pengeskabet op ..", math.random(18000, 30000), false, true, {
                    ...
                    QBCore.Functions.Notify("Succesfuld!", "success")
                    IsDrilling = false
                end, function() -- Cancel
                    StopAnimTask(PlayerPedId(), "anim@heists@fleeca_bank@drilling", "drill_straight_idle", 1.0)
                    TriggerServerEvent('qb-bankrobbery:server:setLockerState', bankId, lockerId, 'isBusy', false)
    ...
    elseif bankId == "pacific" then
        ...
        IsDrilling = true
        QBCore.Functions.Progressbar("open_locker", "Bryder pengeskabet op ..", math.random(27000, 37000), false, true, {
            disableMovement = true,
            disableCarMovement = true,
            disableMouse = false,
            disableCombat = true,
                            ...
                            if not Config.SmallBanks[closestBank]["isOpened"] then
                                QBCore.Functions.TriggerCallback('QBCore:HasItem', function(result)
                                    if result then
                                        ...
                                        QBCore.Functions.Progressbar("hack_gate", "Tilslutter Hackerenheden ..", math.random(5000, 10000), false, true, {
                                            disableMovement = true,
                                            disableCarMovement = true,
                                            disableMouse = false,
                                            disableCombat = true,
                                ...
                                QBCore.Functions.Notify("Det ligner at bankdøren allerede er åben..", "error")
                            end
                        else
                            QBCore.Functions.Notify('Minimum Af '..Config.MinimumFleecaPolice..' Politi Nødvendig', "error")
                        end
                    end
                end
            else
    ...
    if PlayerJob.name == "police" and onDuty then
        ...
        if type == "small" then
            ...
            TriggerEvent('qb-policealerts:client:AddPoliceAlert', {
                timeOut = 10000,
                alertTitle = "Fleeca Bankrøveri Forsøg",
                coords = {
                    x = coords.x,
                    y = coords.y,
                    z = coords.z,
        ...
        elseif type == "paleto" then
            ...
            TriggerEvent('qb-policealerts:client:AddPoliceAlert', {
                timeOut = 10000,
                alertTitle = "Blain County Savings Bankrøveri Forsøg",
                coords = {
                    x = coords.x,
                    y = coords.y,
                    z = coords.z,
        ...
        elseif type == "pacific" then
            ...
            TriggerEvent('qb-policealerts:client:AddPoliceAlert', {
                timeOut = 10000,
                alertTitle = "Pacific Standard Bankrøveri Forsøg",
                coords = {
                    x = coords.x,
                    y = coords.y,
                    z = coords.z,
        ...
        AddTextComponentString("ALARM: Bankrøveri")
