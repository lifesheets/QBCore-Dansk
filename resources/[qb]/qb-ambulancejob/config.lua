...
Config.Locations = {
    ...
    ["vehicle"] = {
        [1] = vector4(293.18, -611.57, 43.38, 34.62),
...
Config.MaxInjuryChanceMulti = 5
Config.ForceInjury = 40
...
Config.MajorArmoredBleedChance = 25
...
Config.BleedingStates = {
    [1] = {label = 'bløder lidt..', damage = 10, chance = 50},
    [2] = {label = 'bløder..', damage = 15, chance = 65},
    [3] = {label = 'bløder meget..', damage = 20, chance = 65},
    [4] = {label = 'bløder rigtig meget..', damage = 25, chance = 75},
}
