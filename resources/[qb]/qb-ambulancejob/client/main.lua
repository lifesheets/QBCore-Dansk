...
BodyParts = {
    ...
    ['SPINE'] = { label = 'rygrad', causeLimp = true, isDamaged = false, severity = 0 },
    ['UPPER_BODY'] = { label = 'overkrop', causeLimp = false, isDamaged = false, severity = 0 },
    ['LOWER_BODY'] = { label = 'underkrop', causeLimp = true, isDamaged = false, severity = 0 },
    ['LARM'] = { label = 'venstre arm', causeLimp = false, isDamaged = false, severity = 0 },
    ['LHAND'] = { label = 'venstre hånd', causeLimp = false, isDamaged = false, severity = 0 },
    ['LFINGER'] = { label = 'venste fingre', causeLimp = false, isDamaged = false, severity = 0 },
    ['LLEG'] = { label = 'venstre ben', causeLimp = true, isDamaged = false, severity = 0 },
    ['LFOOT'] = { label = 'venstre fod', causeLimp = true, isDamaged = false, severity = 0 },
    ['RARM'] = { label = 'højre arm', causeLimp = false, isDamaged = false, severity = 0 },
    ['RHAND'] = { label = 'højre hånd', causeLimp = false, isDamaged = false, severity = 0 },
    ['RFINGER'] = { label = 'højre fingre', causeLimp = false, isDamaged = false, severity = 0 },
    ['RLEG'] = { label = 'højre ben', causeLimp = true, isDamaged = false, severity = 0 },
    ['RFOOT'] = { label = 'højre fod', causeLimp = true, isDamaged = false, severity = 0 },
}

WeaponDamageList = {
	["WEAPON_UNARMED"] = "Næveaftryk",
	["WEAPON_ANIMAL"] = "Bidsår af et dyr",
	["WEAPON_COUGAR"] = "Bidsår af et dyr",
	["WEAPON_KNIFE"] = "Kniv stik",
    ["WEAPON_NIGHTSTICK"] = "Bump fra en pind eller noget lignende",
	["WEAPON_BREAD"] = "Bukke i hovedet fra en baguette!",
	["WEAPON_HAMMER"] = "Bump fra en pind eller noget lignende",
	["WEAPON_BAT"] = "Bump fra en pind eller noget lignende",
	["WEAPON_GOLFCLUB"] = "Bump fra en pind eller noget lignende",
	["WEAPON_CROWBAR"] = "Bump fra en pind eller noget lignende",
	["WEAPON_PISTOL"] = "Pistolkugler i kroppen",
	["WEAPON_COMBATPISTOL"] = "Pistolkugler i kroppen",
	["WEAPON_APPISTOL"] = "Pistolkugler i kroppen",
	["WEAPON_PISTOL50"] = "50 Cal Pistolkugler i kroppen",
	["WEAPON_MICROSMG"] = "SMG kugler i kroppen",
	["WEAPON_SMG"] = "SMG kugler i kroppen",
	["WEAPON_ASSAULTSMG"] = "SMG kugler i kroppen",
	["WEAPON_ASSAULTRIFLE"] = "Riffelkugler i kroppen",
	["WEAPON_CARBINERIFLE"] = "Riffelkugler i kroppen",
	["WEAPON_ADVANCEDRIFLE"] = "Riffelkugler i kroppen",
	["WEAPON_MG"] = "Maskingeværkugler i kroppen",
	["WEAPON_COMBATMG"] = "Maskingeværkugler i kroppen",
	["WEAPON_PUMPSHOTGUN"] = "Haglgeværkugler i kroppen",
	["WEAPON_SAWNOFFSHOTGUN"] = "Haglgeværkugler i kroppen",
	["WEAPON_ASSAULTSHOTGUN"] = "Haglgeværkugler i kroppen",
	["WEAPON_BULLPUPSHOTGUN"] = "Haglgeværkugler i kroppen",
	["WEAPON_STUNGUN"] = "Taser print",
	["WEAPON_SNIPERRIFLE"] = "Sniperkugler i kroppen",
	["WEAPON_HEAVYSNIPER"] = "Sniperkugler i kroppen",
	["WEAPON_REMOTESNIPER"] = "Sniperkugler i kroppen",
	["WEAPON_GRENADELAUNCHER"] = "Forbrændinger og fragmenter",
	["WEAPON_GRENADELAUNCHER_SMOKE"] = "Røgskade",
	["WEAPON_RPG"] = "Forbrændinger og fragmenter",
	["WEAPON_STINGER"] = "Forbrændinger og fragmenter",
	["WEAPON_MINIGUN"] = "Rigtig mange kugler i kroppen",
	["WEAPON_GRENADE"] = "Forbrændinger og fragmenter",
	["WEAPON_STICKYBOMB"] = "Forbrændinger og fragmenter",
	["WEAPON_SMOKEGRENADE"] = "Røgskade",
	["WEAPON_BZGAS"] = "Gasskade",
	["WEAPON_MOLOTOV"] = "Kraftige forbrændinger",
	["WEAPON_FIREEXTINGUISHER"] = "Sprayet på :)",
	["WEAPON_PETROLCAN"] = "Benzindunk skade",
	["WEAPON_FLARE"] = "Flare skade",
	["WEAPON_BARBED_WIRE"] = "Pigtrådsskade",
	["WEAPON_DROWNING"] = "Druknede",
	["WEAPON_DROWNING_IN_VEHICLE"] = "Druknede",
	["WEAPON_BLEEDING"] = "Mistede en masse blod",
	["WEAPON_ELECTRIC_FENCE"] = "Elektrisk hegnssår",
	["WEAPON_EXPLOSION"] = "Mange forbrændinger (fra sprængstoffer)",
	["WEAPON_FALL"] = "Brækkede knogler",
	["WEAPON_EXHAUSTION"] = "Døde af udmattelse",
	["WEAPON_HIT_BY_WATER_CANNON"] = "Vandkanon skind",
	["WEAPON_RAMMED_BY_CAR"] = "Bilulykke",
	["WEAPON_RUN_OVER_BY_CAR"] = "Påkørt af et køretøj",
	["WEAPON_HELI_CRASH"] = "Helikopterstyrt",
        ...
        if #injured > 0 then
            ...
            if #injured <= Config.AlertShowInfo then
                for k, v in pairs(injured) do
                    limbDamageMsg = limbDamageMsg .. "Dit " .. v.label .. " føles "..Config.WoundStates[v.severity]
                    if k < #injured then
                        limbDamageMsg = limbDamageMsg .. " | "
                    end
                end
            else
                limbDamageMsg = "Du har smerter mange steder.."
            end
        ...
        if HasPedBeenDamagedByWeapon(ped, GetHashKey(k), 0) then
            ...
            if not IsInDamageList(k) then
                TriggerEvent('chat:addMessage', {
                    color = { 255, 0, 0},
                    multiline = false,
                    template = '<div class="chat-message status"><strong>{0}</strong>{1}</div>',
                    args = {"Status: ", v}
                })
...
RegisterNetEvent('hospital:client:Revive', function()
    ...
    QBCore.Functions.Notify("Du er helt frisk igen!", "success")
end)
...
RegisterNetEvent('hospital:client:HealInjuries', function(type)
    ...
    TriggerServerEvent("hospital:server:RestoreWeaponDamage")
    QBCore.Functions.Notify("Dine sår er blevet helet!")
end)
...
RegisterNetEvent('hospital:client:SendToBed', function(id, data, isRevive)
    ...
    CreateThread(function ()
        Wait(5)
        if isRevive then
            QBCore.Functions.Notify("Du bliver hjulpet..")
...
RegisterNetEvent('hospital:client:SendBillEmail', function(amount)
    SetTimeout(math.random(2500, 4000), function()
        ...
        TriggerServerEvent('qb-phone:server:sendNewMail', {
            ...
            message = "Kære " .. gender .. " " .. charinfo.lastname .. ",<br /><br />Hermed har du modtaget en mail med omkostningerne ved det sidste hospitalsbesøg.<br />De endelige omkostninger er blevet: <strong>"..amount.." DKK</strong><br /><br />Vi ønsker dig en hurtig bedring!",
            button = {}
        })
    end)
end)
...
CreateThread(function()
    while true do
        ...
        if isInHospitalBed and canLeaveBed then
            sleep = 0
            local pos = GetEntityCoords(PlayerPedId())
            DrawText3D(pos.x, pos.y, pos.z, "~g~E~w~ - For at stå op..")
        ...
        if LocalPlayer.state['isLoggedIn'] then
            ...
            for k, checkins in pairs(Config.Locations["checking"]) do
                if #(pos - checkins) < 1.5 then
                    ...
                    if doctorCount >= Config.MinimalDoctors then
                        DrawText3D(checkins.x, checkins.y, checkins.z, "~g~E~w~ - Ring til læge")
                    else
                        DrawText3D(checkins.x, checkins.y, checkins.z, "~g~E~w~ - Tjek ind")
                    end
                    if IsControlJustReleased(0, 38) then
                        if doctorCount >= Config.MinimalDoctors then
                            ...
                            QBCore.Functions.Progressbar("hospital_checkin", "Tjekker ind..", 2000, false, true, {
                                ...
                                if bedId then
                                    ...
                                    QBCore.Functions.Notify("Sengene er optaget..", "error")
                                end
                            end, function() -- Cancel
                                TriggerEvent('animations:client:EmoteCommandStart', {"c"})
                                QBCore.Functions.Notify("Indtjekning mislykkedes!", "error")
                            end)
                        end
                    end
                elseif #(pos - checkins) < 4.5 then
                    sleep = 5
                    if doctorCount >= Config.MinimalDoctors then
                        DrawText3D(checkins.x, checkins.y, checkins.z, "Kald")
                    else
                        DrawText3D(checkins.x, checkins.y, checkins.z, "Tjek ind")
                    end
                end
            end
            ...
            if closestBed and not isInHospitalBed then
                if #(pos - vector3(Config.Locations["beds"][closestBed].coords.x, Config.Locations["beds"][closestBed].coords.y, Config.Locations["beds"][closestBed].coords.z)) < 2 then
                    sleep = 5
                    DrawText3D(Config.Locations["beds"][closestBed].coords.x, Config.Locations["beds"][closestBed].coords.y, Config.Locations["beds"][closestBed].coords.z + 0.3, "~g~E~w~ - For at ligge i sengen")
                    if IsControlJustReleased(0, 38) then
