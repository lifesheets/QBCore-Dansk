    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action == "ui") {
            if (data.toggle) {
                ...
                var originalText = "Henter spiller data";
                ...
                var DotsInterval = setInterval(function() {
                    ...
                    if (loadingProgress == 4) {
                        originalText = "Henter karakterer"
                        $("#loading-text").html(originalText);
                    }
                    if (loadingProgress == 6) {
                        originalText = "Validerer karakterer"
                        $("#loading-text").html(originalText);
                    }
                    if(loadingDots == 4) {
                        $("#loading-text").html(originalText);
...
function setupCharInfo(cData) {
    if (cData == 'empty') {
        $('.character-info-valid').html('<span id="no-char">Det valgte karakter slot er ikke i brug.<br><br>Denne karakter har ikke noget information endnu.</span>');
    } else {
        var gender = "Mand"
        if (cData.charinfo.gender == 1) { gender = "Dame" }
        ...
        '<div class="character-info-box"><span id="info-label">Penge: </span><span class="char-info-js">'+cData.money.cash+' DKK</span></div>' +
        '<div class="character-info-box"><span id="info-label">Bank: </span><span class="char-info-js">'+cData.money.bank+' DKK</span></div>' +
...
function refreshCharacters() {
    $('.characters-list').html('<div class="character" id="char-1" data-cid=""><span id="slot-name">Tomt Slot<span id="cid"></span></span></div><div class="character" id="char-2" data-cid=""><span id="slot-name">Tomt Slot<span id="cid"></span></span></div><div class="character" id="char-3" data-cid=""><span id="slot-name">Tomt Slot<span id="cid"></span></span></div><div class="character" id="char-4" data-cid=""><span id="slot-name">Tomt Slot<span id="cid"></span></span></div><div class="character" id="char-5" data-cid=""><span id="slot-name">Tomt Slot<span id="cid"></span></span></div><div class="character-btn" id="play"><p id="play-text">Select a character</p></div><div class="character-btn" id="delete"><p id="delete-text">Select a character</p></div>')
    setTimeout(function(){
        $(selectedChar).removeClass("char-selected");
        selectedChar = null;
        $.post('https://qb-multicharacter/setupCharacters');
