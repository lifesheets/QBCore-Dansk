...
Config.MinimumHouseRobberyPolice = 2 -- Skal være 2
...
Config.Rewards = {
    [1] = {
        ...
        ["chest"] = {"plastic", "rolex", "diamond_ring", "goldchain", "weed_skunk", "thermite", "cryptostick"},
