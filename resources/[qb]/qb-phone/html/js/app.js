...
$(document).on('click', '.phone-application', function(e){
    ...
    if (AppObject.length !== 0) {
        if (CanOpenApp) {
            if (QB.Phone.Data.currentApplication == null) {
                ...
                if (PressedApplication == "settings") {
                    ...
                    $("#mySerialNumber").text("DRP-" + QB.Phone.Data.PlayerData.metadata["phonedata"].SerialNumber);
        ...
        if (PressedApplication != null){
            QB.Phone.Notifications.Add("fas fa-exclamation-circle", "System", QB.Phone.Data.Applications[PressedApplication].tooltipText+" er ikke tilgængelig!")
        }
    }
});
    ...
    window.addEventListener('message', function(event) {
        switch(event.data.action) {
            ...
            case "UpdateMentionedTweets":
                ...
                break;
            case "UpdateBank":
                $(".bank-app-account-balance").html(""+event.data.NewBalance+" DKK");
            ...
            case "UpdateCallTime":
                ...
                if (!QB.Phone.Data.IsOpen) {
                    ...
                    $(".call-notifications-title").html("I opkald ("+timeString+")");
                    $(".call-notifications-content").html("Taler med "+event.data.Name);
                ...
                $(".phone-currentcall-title").html("I opkald ("+timeString+")");
                break;
