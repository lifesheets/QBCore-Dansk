SetupLawyers = function(data) {
    ...
    if (data.length > 0) {
        ...
        if (lawyers.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ingen advokater til rådighed.</div></div>'
            $(".lawyers-list").append(element);
        }

        $(".lawyers-list").append('<h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; border-top-left-radius: .5vh; border-top-right-radius: .5vh; width:100%; display:block; background-color: rgb(119, 3, 252);">Bilforhandlere (' + cardealer.length + ')</h1>');

        if (cardealer.length > 0) {
            $.each(cardealer, function(i, lawyer6) {
                var element = '<div class="lawyer-list" id="lawyerid-' + i + '"> <div class="lawyer-list-firstletter" style="background-color: rgb(119, 3, 252);">' + (lawyer6.name).charAt(0).toUpperCase() + '</div> <div class="lawyer-list-fullname">' + lawyer6.name + '</div> <div class="lawyer-list-call"><i class="fas fa-phone"></i></div> </div>'
                $(".lawyers-list").append(element);
                $("#lawyerid-" + i).data('LawyerData', lawyer6);
            });
        } else {
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ingen bilforhandlere til rådighed.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (realestate.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ingen ejendomsmæglere til rådighed.</div></div>'
            $(".lawyers-list").append(element);
        }

        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(0, 204, 102);">Mekanikere (' + mechanic.length + ')</h1>');
        ...
        if (mechanic.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ingen mekanikere til rådighed.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (taxi.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ingen taxaer til rådighed.</div></div>'
            $(".lawyers-list").append(element);
        }
        ...
        if (police.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ikke noget politi til rådighed.</div></div>'
            $(".lawyers-list").append(element);
        }
        
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(255, 0, 0);">Læger (' + ambulance.length + ')</h1>');
        ...
        if (ambulance.length > 0) {
            ...
            var element = '<div class="lawyer-list"><div class="no-lawyers">Der er ingen læger til rådighed.</div></div>'
            $(".lawyers-list").append(element);
        }
    } else {
        $(".lawyers-list").append('<h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; border-top-left-radius: .5vh; border-top-right-radius: .5vh; width:100%; display:block; background-color: rgb(42, 137, 214);">Advokater (' + lawyers.length + ')</h1>');
        ...
        $(".lawyers-list").append('<br><h1 style="font-size:1.641025641025641vh; padding:1.0256410256410255vh; color:#fff; margin-top:0; width:100%; display:block; background-color: rgb(119, 3, 252);">Bilforhandlere (' + cardealer.length + ')</h1>');
                ...
                if (status.CanCall) {
                    if (!status.InCall) {
                        if (QB.Phone.Data.AnonymousCall) {
                            QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Du startede et anonymt opkald!");
                        }
                        ...
                        QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Du er allerede forbundet til et opkald!");
                    }
                } else {
                    QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Denne person er allerede i et opkald");
                }
            } else {
                QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Denne person er ikke tilgængelig!");
            }
        } else {
            QB.Phone.Notifications.Add("fas fa-phone", "Telefon", "Du kan ikke ringe til dit eget nummer!");
        }
    });
});
