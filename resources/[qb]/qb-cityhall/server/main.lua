...
RegisterNetEvent('qb-cityhall:server:sendDriverTest', function()
    ...
    TriggerClientEvent('QBCore:Notify', src, 'Der er sendt en mail til køreskolerne, og du vil automatisk blive kontaktet', "success", 5000)
end)
...
RegisterNetEvent('qb-cityhall:server:ApplyJob', function(job)
    ...
    TriggerClientEvent('QBCore:Notify', src, 'Tillykke med dit nye job! ('..JobInfo.label..')')
end)
