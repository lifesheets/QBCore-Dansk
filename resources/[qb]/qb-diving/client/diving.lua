...
RegisterNetEvent('qb-diving:server:CallCops', function(Coords, msg)
    ...
    BeginTextCommandSetBlipName('STRING')
    AddTextComponentString("112 - Dykkerområde")
...
RegisterNetEvent('qb-diving:client:UseGear', function(bool)
    if bool then
        GearAnim()
        QBCore.Functions.Progressbar("equip_gear", "Tag en dykkerdragt på", 5000, false, true, {}, {}, {}, {}, function() -- Done
            DeleteGear()
            ...
            TriggerEvent('chatMessage', "SYSTEM", "error", "/divingsuit for at tage dykkerdragten af")
        end)
    else
        if currentGear.enabled then
            GearAnim()
            QBCore.Functions.Progressbar("remove_gear", "Tager dykkerudstyret af..", 5000, false, true, {}, {}, {}, {}, function() -- Done
                DeleteGear()
