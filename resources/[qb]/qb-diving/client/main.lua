...
RegisterNetEvent('QBCore:Client:OnPlayerLoaded', function()
    ...
    if PlayerJob.name == "police" then
        ...
        AddTextComponentSubstringPlayerName("Politibåd")
...
RegisterNetEvent('qb-diving:client:UseJerrycan', function()
    ...
    if boat then
        ...
        QBCore.Functions.Progressbar("reful_boat", "Optanker båd ..", 20000, false, true, {
            ...
            QBCore.Functions.Notify('Båden er blevet tanket op', 'success')
            ...
            QBCore.Functions.Notify('Optankning er blevet annulleret!', 'error')
        end)
    else
