    ...
    if (itemData != null && itemData.info != "") {
        if (itemData.name == "id_card") {
            ...
            $(".item-info-description").html(
                "<p><strong>Borger ID: </strong><span>" +
                itemData.info.citizenid +
                "</span></p><p><strong>Navn: </strong><span>" +
            ...
            */
            ...
            $(".item-info-description").html(
                ...
                "</span></p><p><strong>Efternavn: </strong><span>" +
                itemData.info.lastname +
                "</span></p><p><strong>Borger ID: </strong><span>" +
                itemData.info.citizenid +
                "</span></p>"
            );
            ...
            if (itemData.info.type == "casing") {
                $(".item-info-description").html(
                    ...
                    "</span></p><p><strong>Kaliber: </strong><span>" +
                    itemData.info.ammolabel +
                    "</span></p><p><strong>Serienummer: </strong><span>" +
                    itemData.info.serie +
                    "</span></p><p><strong>Gerningssted: </strong><span>" +
                ...
                $(".item-info-description").html(
                    "<p><strong>Bevismateriale: </strong><span>" +
                    itemData.info.label +
                    "</span></p><p><strong>Blodtype: </strong><span>" +
            ...
            $(".item-info-title").html("<p>" + itemData.label + "</p>");
            $(".item-info-description").html(
                "<p><strong>Mængde penge: </strong><span>" +
                itemData.info.cash +
                " DKK</span></p>"
            );
...
function handleDragDrop() {
    $(".item-drag").draggable({
            ...
            if (dragAmount == 0) {
                if (itemData.price != null) {
                    ...
                    $(".ui-draggable-dragging")
                        ...
                        .html("(" + itemData.amount + ") " + itemData.price + " DKK");
        ...
        stop: function() {
            ...
            $(this).css("background", "rgba(48, 48, 48, 0.8)");
...
(() => {
    ...
    Inventory.UseItem = function(data) {
        ...
        $("#itembox-action").html("<p>Brugte</p>");
        ...
        if (data.toggle) {
            if (!requiredItemOpen) {
                ...
                $.each(data.items, function(index, item) {
                    var element =
                        '<div class="requiredItem-box"><div id="requiredItem-action">Påkrævet</div><div id="requiredItem-label"><p>' +
                        item.label +
