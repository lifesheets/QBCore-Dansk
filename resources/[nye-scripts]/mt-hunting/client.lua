...
Citizen.CreateThread(function()
	...
	AddTextComponentSubstringPlayerName("Jagtbutik")
                    ...
                    if (DoesEntityExist(v.entity)) then
                        if (IsEntityDead(v.entity)) then
                            if (GetDistanceBetweenCoords(pos, rpos.x, rpos.y, rpos.z, true) < 1.1) then
                                exports['qb-core']:DrawText('[E] SKÆR DYR','left')
                                if IsControlJustPressed(0, 38) and
                                    ...
                                    QBCore.Functions.Progressbar('apanhar_animal', 'Skærer Dyr...', 5000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
...
AddEventHandler('mt-hunting:client:LojaCaca', function()
    QBCore.Functions.Progressbar('loja_caca', 'Åbner Butik...', 1000, false, true, { -- Name | Label | Time | useWhileDead | canCancel
        disableMovement = true,
        disableCarMovement = true,
        disableMouse = false,
        disableCombat = true,
...
AddEventHandler('mt-hunting:client:MenuLoja', function()
    exports['qb-menu']:openMenu({
        ...
        {
            header = "Køb snigskytte ammunition",
            txt = "Pris: 1000 DKK",
            params = {
        ...
        {
            header = "Sælg alt kød",
            txt = "Sælg alt det kød du har på dig",
            params = {
