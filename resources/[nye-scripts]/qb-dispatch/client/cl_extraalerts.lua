...
local function ArtGalleryRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Kunstgalleri Røveri", -- message
...
local function HumaneRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Humane Labs Røveri", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function TrainRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Tog Røveri", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function VanRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Sikkerhedsvogn Røveri", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function UndergroundRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Bunker Røveri", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function DrugBoatRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Mistænkelig Båd", -- message
        job = {"police"} -- jobs that will get the alerts
    })
...
local function UnionRobbery()
    ...
    TriggerServerEvent("dispatch:server:notify",{
        ...
        dispatchMessage = "Union Depository Røveri", -- message
        job = {"police"} -- jobs that will get the alerts
    })
