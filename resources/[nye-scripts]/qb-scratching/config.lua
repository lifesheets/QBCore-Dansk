...
Config.Locale = 'en'
 ...
 Config.Prices = {
  Nothing = {
    chance = 50,
    message = 'Du vandt desværre ikke noget.',
    price = {
      price_money = 0,
      item = {
        price_is_item = false,
...
Config.ScratchCooldownInSeconds = 0 -- Cooldown in SECONDS, when will player be able to scratch another ticket? If below 30 will show notification until timer finished
